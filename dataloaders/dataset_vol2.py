...
class VolleyballDataset(Dataset):
    ...
    def __init__(self, dataset='volleyball', split='train', clip_len=16, preprocess=False):
        ...
        self.resize_height = 64#192#256#112#780
        self.resize_width = 64#112#384#112#1280
    ...
    def __getitem__(self, index):
        ...
        return torch.from_numpy(buffer[::2,:,:,:,:]), torch.from_numpy(labels), torch.from_numpy(dist)
